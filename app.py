...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message_reply.reply_text("Hii! Mention me with a topic like '@Binary_Joke_Bot python' to get a joke")

async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message_reply.reply_text("Hii! Mention me with a topic like '@Binary_Joke_Bot python' to get a funny joke")

# async def generate_joke(update: Update, context: ContextTypes.DEFAULT_TYPE):
#     await update.message_reply.reply_text(f"Generating a joke about (topic)")
#     joke = setup_llm_chain(topic).invoke({}).strrip()
